      ...
      {({ open }) => (
        <>
          <div className="relative">
            <Listbox.Button className="relative w-full min-w-[110px] cursor-pointer rounded-full border border-main-blue bg-main-blue py-1.5 pl-4 pr-4 text-left text-white sm:min-w-[144px]">
